...
"""Verify that starting oro with -h works as expected."""
import subprocess

from test_framework.test_framework import OroTestFramework
from test_framework.util import assert_equal

class HelpTest(OroTestFramework):
    ...
    def run_test(self):
        self.log.info("Start oro with -? for help text")
        ...
        self.log.info("Start oro with -version for version information")
