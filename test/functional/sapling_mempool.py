#!/usr/bin/env python3
# Copyright (c) 2020 The ORO Core developers
...
class SaplingMempoolTest(OroTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 ORO note to Alice
        ...
        # miner sends another 10 ORO note to Alice
