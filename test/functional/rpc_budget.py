...
class BudgetProposalTest(OroTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 ORO allowed" % invalid_amt, self.nodes[0].preparebudget,
