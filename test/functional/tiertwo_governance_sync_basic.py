...
from test_framework.test_framework import OroTier2TestFramework
...
class MasternodeGovernanceBasicTest(OroTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.oro.exchange/t/test-proposal"
