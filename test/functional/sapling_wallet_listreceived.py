...
class ListReceivedTest (OroTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 ORO.
        ...
        # Send 1 ORO to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 ORO sending them all (fee is 0.1 ORO)
        ...
        # Confirm transaction (2 ORO from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 ORO, send 0.6 ORO + 0.05 ORO fee
