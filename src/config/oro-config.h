/* src/config/oro-config.h.  Generated from oro-config.h.in by configure.  */
/* src/config/oro-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/oro-cm/ORO/issues"
