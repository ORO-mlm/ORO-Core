...
SettingsFaqWidget::SettingsFaqWidget(OROGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableORO,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableORO,
    ...
    connect(ui->pushButton_UnspendableORO, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableORO);});
    ...
    if (parent)
        connect(parent, &OROGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
