...
pkgdatadir = $(datadir)/oro
pkgincludedir = $(includedir)/oro
pkglibdir = $(libdir)/oro
pkglibexecdir = $(libexecdir)/oro
...
CONFIG_HEADER = $(top_builddir)/src/config/oro-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/oro-config.h.in \
...
ACLOCAL = ${SHELL} /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
ARM_CRC_CXXFLAGS = 
AUTOCONF = ${SHELL} /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0/build-aux/missing automake-1.16
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = oro-cli
BITCOIN_DAEMON_NAME = orod
BITCOIN_GUI_NAME = oro-qt
BITCOIN_TX_NAME = oro-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = oro
PACKAGE_BUGREPORT = https://github.com/oro-cm/ORO/issues
PACKAGE_NAME = ORO Core
PACKAGE_STRING = ORO Core 1.1.0
PACKAGE_TARNAME = oro
PACKAGE_URL = https://oro.exchange/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0
abs_srcdir = /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0
abs_top_builddir = /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0
abs_top_srcdir = /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ksk/Works/2020/2020-11/ORO_new/works/Ubuntu_works/Oro-1.1.0/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/oro-cli.bash-completion \
	       $(top_srcdir)/contrib/oro-tx.bash-completion \
	       $(top_srcdir)/contrib/orod.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/oro.ico \
  $(top_srcdir)/share/pixmaps/nsis-header.bmp \
  $(top_srcdir)/share/pixmaps/nsis-wizard.bmp \
  $(top_srcdir)/doc/README_windows.txt

LINUX_PACKAGING = $(top_srcdir)/share/pixmaps/oro16.xpm \
  $(top_srcdir)/share/pixmaps/oro32.xpm \
  $(top_srcdir)/share/pixmaps/oro128.png
...
COVERAGE_INFO = baseline.info \
  test_oro_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_oro_coverage.info test_oro.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/ORO-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings \
...
src/config/oro-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/oro-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/oro-config.h
$(top_srcdir)/src/config/oro-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/oro-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/ORO-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ORO-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/ORO-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_oro.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_oro -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_oro_filtered.info: test_oro.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_oro_filtered.info
...
#test_oro_coverage.info: baseline_filtered.info test_oro_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_oro_filtered.info -o $@

#total_coverage.info: test_oro_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_oro_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_oro.coverage/.dirstamp:  test_oro_coverage.info
...
#cov: test_oro.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_oro.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
